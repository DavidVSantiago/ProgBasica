...
int main() {
  ...
  std::cout << "Digite o salario bruto mensal: R$";
  std::cin >> salario;
  ...
  std::cout << "Aliquota: " << aliquota << "%" << std::endl;
  std::cout << "Imposto mensal: R$" << impostoMensal << std::endl;
  std::cout << "Imposto anual: R$" << impostoAnual << std::endl;
}